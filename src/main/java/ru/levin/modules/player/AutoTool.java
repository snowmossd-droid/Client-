...
public class AutoTool extends Function {
    ...
    public static int getBest(final BlockPos pos) {
        ...
        Optional<RegistryEntry.Reference<Enchantment>> efficiencyEntry = mc.world.getRegistryManager()
        ...
        for (int i = 0; i < 9; ++i) {
            ...
            if (efficiencyEntry.isPresent()) {
                digSpeed = net.minecraft.enchantment.EnchantmentHelper.getLevel(efficiencyEntry.get(), stack);
            }
